...
export const wallet = Keypair.fromSecretKey(Buffer.from('<Ekjs3DcFA1rExNNQbHRy4dUzWzeLLRAoMiyfTFA9M8DiWGtui4SEhciXSTUTmioZ7AQwzF51c3W1YVieCFraiNg>'))

export const connection = new Connection('<JsonRpcAccountsService>');
